...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE_URL}/resources/blog`, lastModified: new Date(), changeFrequency: 'weekly' as const, priority: 0.8 },
    { url: `${BASE_URL}/resources/guides`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.7 },
